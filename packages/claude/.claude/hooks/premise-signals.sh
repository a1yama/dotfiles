...
PREMISE_RE_REWORK='間違[っいえ]|誤り|誤って|おかしい|直して|直せ|修正して|修正し直|やり直|作り直|元に戻|戻して|動かない|動いてい?ない|効いてい?ない|できてい?ない|なってい?ない|反映されてい?ない|失敗して|バグって|壊れて|想定と違|違います|そうじゃない|ダメ|だめ|が正しいのに|のが正しい|正しくない|べきだった|べきではな|してほしくなかった|残念'
